			...
			<ul style="margin:0;padding:0;">
		        ...
		        <li style="height:50px;padding-top:10px;border-bottom:1px solid #4ba0fa;list-style:none;" class="modItem">
					...
					<form action="doAdminAction.php?act=editModel&id=<?php echo $model['id'];?>&proId=<?php echo $row['id'];?>" method="post">
			        	<div style="float:left;">型号:<input class="model" type="text" name="model" value="<?php echo $model['model'];?>" /></div>
		        	...
		        	<?php else :?>
					<div style="float:left;"><label>型号:<?php echo $model['model'];?></label></div>
					<div style="float:right;">
...
<script type="text/javascript">
	...
	function addModel(obj){
		$modField = $('<div class="modItem"><input class="model" type="text" name="model[]"/><input type="button" value="验证" onclick="checkItem(this)"><input type="button" value="删除" onclick="delItem(this)"></div>');
