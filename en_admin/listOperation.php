...
$sql="select o.id from en_operation_log o 
      join en_tableinfo t on o.tableId=t.id 
      join en_crudinfo c on o.crudId=c.id where 1 {$where}";
...
$sql="select o.*,t.tableCname,c.crudCname from en_operation_log o 
      join en_tableinfo t on o.tableId=t.id 
      join en_crudinfo c on o.crudId=c.id where 1{$where} order by o.time desc limit {$offset},{$pageSize}";
$rows=fetchAll($sql);
$table = fetchAll("select id,tableCname from en_tableinfo");
?>
<!doctype html>
<html>
<head>
