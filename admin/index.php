...
<body>
    ...
    <div class="operation_user clearfix">
        <div class="link fr">
            ...
            </b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.randn.cn/index.php" target="_blank" class="icon icon_i">首页</a><span></span><a href="http://www.randn.cn/admin/index.php" class="icon icon_n">刷新</a><span></span><a href="doAdminAction.php?act=logout" class="icon icon_e">退出</a>
        </div>
    </div>
